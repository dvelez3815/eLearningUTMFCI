      ...
      <div className="">
        <nav className="relative w-full   bg-green-800  dark:bg-gray-800  shadow  ">
          <div className="mx-auto  ">
            <div className="flex items-center  px-10 justify-between h-16">
              ...
              <div className="p-2 flex ">
                <h2 className="hidden md:block uppercase text-xs md:text-base lg:text-base sm:text-base  pt-1 text-white">
