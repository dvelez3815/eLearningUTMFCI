...
<div className="relative pt-1 max-w-7xl mx-auto px-8">
  <div className="flex flex-col sm:flex-row mb-7 items-center justify-between">
    <div>
      {props.bloqueo? 
      <span className="text-xl text-lowercase capitalize  font-bold inline-block py-2 px-2 uppercase rounded-full text-gray-00 bg-amber-200">
        {props.moduleName} 
      </span>
      :
      <span className="text-xl text-lowercase capitalize  font-bold inline-block py-2 px-2 uppercase rounded-full text-yellow-600 bg-amber-200">
        {props.moduleName} 
      </span>
      }
    ...
    <div className="">
      ...
      :
      <span className="text-xl font-bold text-lowercase  inline-block text-green-800">
      {props.percent}% completed
      </span> 
      }
