...
import listeningimg from "../../assets/icons/teacher.png"
...
import listeningimgng from "../../assets/icons/teacher_0.png"
  ...
  return <div className=' w-full'>
    ...
    <div className='md:p-3'>
      ...
      {props.modulo.map((modulo, index) => {
        ...
        let total_task = (modulo.writing.total_task + modulo.grammar.total_task + modulo.reading.total_task + modulo.vocabulary.total_task + modulo.listening.total_task);
        ...
        return (<div key={shortid.generate()} >
          ...
          {modulo.vocabulary.total_task !== 0 &&
            <Activity
          ...
          {modulo.listening.total_task !== 0 &&
            <Activity
              rutaReview={`/review/${modulo.book_info.book}/${modulo.book_info.module}/${modulo.book_info.unit}/listening`}
              moduleName={`Module: ${modulo.book_info.module}`}
              ruta={`/modulo/${modulo.book_info.module}/listening/${modulo.book_info.unit}/${modulo.listening.task_id}`}
              taskid={modulo.listening.task_id}
              percent={parseInt(
                (modulo.listening.user_progress /
                  modulo.listening.total_task) *
                100
              )}
              key={shortid.generate()}
              name={"listening"}
              img={props.bloqueo ? listeningimgng : listeningimg}
              bloqueo={props.bloqueo}
              info={modulo}
              task={props.lecciones}
            />
