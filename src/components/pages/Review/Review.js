...
const Review = () => {
    ...
    return (
        <div>
            {loadingData ? <div className="pt-20"><img src={loading} alt="cargando"></img></div> :data.length>0?<Ejercicio ejercicios={data} taskInfo={taskinfo}  esPrueba = {false}/>:<NotFoundPage></NotFoundPage>}
