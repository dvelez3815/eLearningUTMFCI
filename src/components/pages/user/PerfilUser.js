  ...
  if ((await roldAdd).value) {
    ...
    setCargando(true);
      ...
      if(_updateUser.msg === "ERROR"){
        ...
        cookies.set("name", form.username.toUpperCase(), { path: "/" });
        cookies.set("lastname",form.lastname.toUpperCase(), { path: "/" });
                    ...
                    <div className="px-6">
                      ...
                      <div className="text-center mt-12 pt-5">
                        ...
                        <div className="text-sm leading-normal mt-0 mb-2 text-gray-600 ">
                          Se unió el { new Date(cookies.get('creado')).toLocaleDateString("es-ES", options)}
                          ...
                          <div className="md:pt-0 w-full lg:w-9/12 px-4">
                                  ...
                                  <div className="hidden md:block overflow-auto py-4 border rounded-lg lg:overflow-visible ">
                                    <div className="mt-4 lg:mb-0 mb-4">
                                      ...
                                      <a href='https://www.facebook.com/utmmanabi/' target ='_blank' 
                                      ...
                                      <a href='https://www.instagram.com/utmmanabii/' target ='_blank' 
                                      ...
                                      <a href='https://twitter.com/UTMManabi' target ='_blank' 
