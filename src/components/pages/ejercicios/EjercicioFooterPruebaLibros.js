      ...
      <div className="">
        {props.juego.length > 0 ? (
          ...
          <div className="w-full flex flex-col  justify-center items-center ">
                      ...
                      <div className="md:p-5 pb-3">
                        ...
                        <div className="md:flex justify-center">
                          <div className=" ">
                            <Link to="/evaluacion">
                              <button
                                 className=" inline-flex items-center justify-center px-10 py-2  bg-green-300 hover:bg-green-500 text-black rounded-full font-semibold text-xs   uppercase tracking-widest "
                              >
                                Continue
                              </button>
                            </Link>
                          ...
                          <div className="md:pl-2 pt-2 md:pt-0 md:pb-1">
                            <button
                              ...
                              className="  px-11  py-2  bg-yellow-300 hover:bg-yellow-500 rounded-full font-semibold text-xs   uppercase "
                            >
                              TRY AGAIN
                            </button>
                          </div>
            ...
            <div
              className="md:pt-2 pt-10 relative flex flex-col min-w-0 break-words  w-full mb-6 px-4 md:px-10"
              id="review"
            >
...
const validarRespuesta = async (props) => {
  ...
  if (tipo_ejercicio === "opcion_correcta_1") {
    ...
    await verificarOrdenar(props, hijos, aciertos, respuestasBackEndOrdenadas);
