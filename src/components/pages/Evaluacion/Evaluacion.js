                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <Link to={`/pruebas/libro/` + 1}>
                    <div className="border-4 border-gray-200 p-5 rounded-lg focus:shadow-outline hover:bg-yellow-200">
                      ...
                      <div className="px-1 py-1 ">BOOK 1</div>
                    </div>
                  </Link>
                  <Link to={`/pruebas/libro/` + 2}>
                    <div className="border-4 border-gray-200 p-5 rounded-lg focus:shadow-outline hover:bg-yellow-200">
                      ...
                      <div className="px-1 py-1 ">BOOK 2</div>
                    </div>
                  </Link>
                  <Link to={`/pruebas/libro/` + 3}>
                    <div className="border-4 border-gray-200 p-5 rounded-lg focus:shadow-outline hover:bg-yellow-200">
                      ...
                      <div className="px-1 py-1 ">BOOK 3</div>
                    </div>
                  </Link>
                  <Link to={`/pruebas/libro/` + 4}>
                    <div className="border-4 border-gray-200 p-5 rounded-lg focus:shadow-outline hover:bg-yellow-200">
                      ...
                      <div className="px-1 py-1 ">BOOK 4</div>
                    </div>
                  </Link>
                  <Link to={`/pruebas/libro/` + 5}>
                    <div className="border-4 border-gray-200 p-5 rounded-lg focus:shadow-outline hover:bg-yellow-200">
                      ...
                      <div className="px-1 py-1 ">BOOK 5</div>
                    </div>
                  </Link>
                </div>
              </div>
