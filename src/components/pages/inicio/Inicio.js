    ...
    return (
      <div>
          ...
          <div className="md:col-span-2">
           ...
           <div className="border rounded-2xl flex flex-col w-4/6 text-left p-2">
             <div className="flex flex-col-2">
               ...
               <h2 className=" font-semibold text-xl m-2 text-yellow-300 ">{this.state.progresoTotal}% </h2>
               </div>
             </div>
        ...
        <div className="flex flex-col-2">
               ...
               <div className="text-right">
               <h2 className=" font-semibold text-xl m-2 text-yellow-300 ">{this.state.progresoModulo}% </h2>
               </div>
             </div>
